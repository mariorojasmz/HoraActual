...
SECRET_KEY = 'y!b$(m2d0c1t6*fjr0u2*&zn^74_!e@(5z0(=t&td+is_n=i-x'
...
# Mario Rojas: Se agrega el framework rest y la aplicacion horactual
INSTALLED_APPS = [
    'django.contrib.auth', 
...
#EMAIL_HOST_USER ='mariorojasmz@gmail.com'
#EMAIL_HOST_PASSWORD='1alucard'
#EMAIL_PORT = 587